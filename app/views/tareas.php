  ...
  <table class="table">
    ...
    <tbody>
      ...
      <td><?php if($_SESSION["tipo"] == "A"){?><a href="../controller/deletetask.php?id=<?php echo $id; ?>"><img title="Eliminar" src="../vendor/img/xbutton.png"></a><?php } ?>&nbsp&nbsp&nbsp&nbsp
              <a href="../controller/modtask.php?id=<?php echo $id; ?>"><img title="Editar" src="../vendor/img/edit.png"></a>&nbsp&nbsp&nbsp&nbsp
              <a href="../controller/modtask.php?id=<?php echo $id; ?>"><img title="Ver" src="../vendor/img/loupe.png"></a></td>
        </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
